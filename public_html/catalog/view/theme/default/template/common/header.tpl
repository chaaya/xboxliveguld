      ...
      <ul class="list-inline">
        ...
        <li class="dropdown"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <span><?php echo $text_account; ?></span> <span class="caret"></span></a>
          <ul class="dropdown-menu dropdown-menu-right">
            <?php if ($logged) { ?>
            <li><a href="<?php echo $account; ?>"><i class="fa fa-user fa-fw"></i> <?php echo $text_account; ?></a></li>
            <li><a href="http://xboxliveguld.se/index.php?route=account/serial_keys"><i class="fa fa-gamepad fa-fw"></i> My Codes</a></li>
            <li><a href="<?php echo $order; ?>"><i class="fa fa-file-text-o fa-fw"></i> <?php echo $text_order; ?></a></li>
            <li><a href="<?php echo $logout; ?>"><i class="fa fa-sign-out fa-fw"></i> <?php echo $text_logout; ?></a></li>
            <?php } else { ?>
            <li><a href="<?php echo $register; ?>"><?php echo $text_register; ?></a></li>
            <li><a href="<?php echo $login; ?>"><i class="fa fa-sign-in fa-fw"></i> <?php echo $text_login; ?></a></li>
            <?php } ?>
          </ul>
        </li>
